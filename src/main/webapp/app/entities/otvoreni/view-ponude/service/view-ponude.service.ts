...
export class ViewPonudeService {
  ...
  public resourceUrlPostupak = this.applicationConfigService.getEndpointFor('api/view-ponude', 'otvoreni');

  protected resourceUrlSifraPonude = this.applicationConfigService.getEndpointFor('api/view_ponude-sifra-ponude', 'otvoreni');
  protected resourceUrlPonudePonudjaci = this.applicationConfigService.getEndpointFor('api/ponudjaci_ponude', 'otvoreni');
  ...
  findSiftraPostupak(sifra_postupka: number): any {
    return this.http.get<IViewPonude[]>(`${this.resourceUrlPostupak}/${sifra_postupka}`);
  }
